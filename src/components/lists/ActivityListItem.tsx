...
function ActivityListItem({ iconUrl, status }: ActivityListItemProps) {
  return (
      ...
      <div className="flex flex-row gap-4 w-full">
        <div className="inline-flex">
          <div className="block [align-self:start] relative">
            <div
              className={`flex justify-center items-center w-[32px] h-[32px] max-w-[32px] flex-[0_0_32px] overflow-hidden text-xs leading-5 md:text-sm md:leading-[1.375rem] bg-[rgb(100,_108,_255,_0.15)]  border border-solid border-transparent rounded-[50%] uppercase ${
                status === "confirmed"
                  ? "bg-[rgb(100,_108,_255,_0.15)] text-brand-500"
                  : "bg-[rgb(232,_143,_151,_0.15)] text-error-200"
              }`}
            >
              <span
        ...
        <div className="inline-flex w-full overflow-hidden">
          <div className="inline-flex flex-col w-[33.333333%] sm-width-576">
            ...
            <div className="text-sm leading-[1.375rem] md:text-[1rem] md:leading-6 font-medium text-left text-ellipsis whitespace-nowrap overflow-hidden text-secondary-900">
              <div
                className={`inline ${
                  status == "confirmed" ? "text-success-500" : "text-error-500"
                }`}
              >
