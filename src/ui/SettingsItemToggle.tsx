        ...
        <div className="text-secondary-500 text-[0.895rem] leading-[140%]">
          {showLink ? (
            <span>
              ...
              <a
                href={linkUrl}
                className="inline-flex justify-center items-center p-0 px-0 text-brand-500 h-auto decoration-[none] align-top bg-transparent relative cursor-pointer select-none"
              >
                Learn more
              </a>
            </span>
